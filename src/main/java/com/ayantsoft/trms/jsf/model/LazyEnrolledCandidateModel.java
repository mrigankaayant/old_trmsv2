...
public class LazyEnrolledCandidateModel extends LazyDataModel<Candidate> {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 5576783424304723204L;

	private List<Candidate> candidates;
	private CandidateService candidateService;

	public LazyEnrolledCandidateModel(CandidateService candidateService) {
	...
	public List<Candidate> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		Object[] resultWithCount = candidateService.candidateFilterForEnrolled(first, pageSize, sortField, sortOrder, filters);
