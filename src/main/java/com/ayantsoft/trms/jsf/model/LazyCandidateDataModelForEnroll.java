...
public class LazyCandidateDataModelForEnroll extends LazyDataModel<Candidate> {
	
	
	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 394645461286699692L;
	
	private List<Candidate> candidates;
	private CandidateService candidateService;

	public LazyCandidateDataModelForEnroll(CandidateService candidateService) {
	...
	public List<Candidate> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		Object[] resultWithCount = candidateService.candidateFilterForHr(first, pageSize, sortField, sortOrder, filters);
