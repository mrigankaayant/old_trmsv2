...
public class LazyCandidateDataModelForSales extends LazyDataModel<Candidate> {
	...
	public LazyCandidateDataModelForSales(CandidateService candidateService) {
	...
	public List<Candidate> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		Object[] resultWithCount = candidateService.candidateFilterForSales(first, pageSize, sortField, sortOrder, filters);
