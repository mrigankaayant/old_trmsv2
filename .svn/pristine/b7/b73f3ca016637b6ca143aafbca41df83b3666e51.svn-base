...
public class LazyCandidateDataModelForPlaced extends LazyDataModel<Candidate> {
	
	
	/**
	 *serialVersionUID 
	 */
	private static final long serialVersionUID = 1556901186931178319L;
	
	private List<Candidate> candidates;
	private CandidateService candidateService;

	public LazyCandidateDataModelForPlaced(CandidateService candidateService) {
	...
	public List<Candidate> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		Object[] resultWithCount = candidateService.candidateFilterForPlaced(first, pageSize, sortField, sortOrder, filters);
